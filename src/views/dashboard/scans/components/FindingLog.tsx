    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            {findings.map((finding, i) => (
                <div key={i} className="bg-card/40 backdrop-blur-xl border border-border/10 rounded-[24px] p-6 shadow-xl hover:border-primary/30 transition-all group animate-in slide-in-from-right-4 duration-500" style={{ animationDelay: `${i * 150}ms` }}>
                    <div className="flex justify-between items-start mb-4">
                        <span className={`px-3 py-1 rounded-full text-[9px] font-extrabold uppercase tracking-widest ${finding.severity === 'Critical' ? 'bg-red-500 text-white shadow-[0_0_8px_rgba(239,68,68,0.4)]' :
            ...
            <div className="mt-auto pt-10 flex items-center justify-between text-[11px] font-bold px-2 uppercase tracking-widest">
